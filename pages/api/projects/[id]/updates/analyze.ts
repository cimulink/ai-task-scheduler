...
import { updateAnalyzer, UpdateAnalysisInput } from '@/lib/updates/updateAnalyzer'
import { z } from 'zod'
...
export default async function handler(
  ...
  try {
    ...
    const analysisInput: UpdateAnalysisInput = {
      projectId: id,
      updateDescription: validatedData.updateDescription,
      existingTasks: project.tasks
    }

    const result = await updateAnalyzer.analyzeUpdate(analysisInput)
